...
echo "\x09\x09java -cp out Main" >> Makefile &&
echo "\x09\x09echo \x22\x09\x22\x22\x22 >> src/main.cbl" >> Makefile &&
echo "b:\xa\x09\x09javac -cp src src/Main.java -d out" >> Makefile &&
echo "\x09\x09java -cp out Main" >> Makefile &&
echo "\x09\x09echo \x22\x09\x22\x22\x22 >> src/main.cbl" >> Makefile &&
echo "d:\xa\x09\x09wget https://repo1.maven.org/maven2/org/junit/platform/junit-platform-console-standalone/1.9.3/junit-platform-console-standalone-1.9.3.jar" >> Makefile &&
echo "\x09\x09echo \x22\x09\x22\x22\x22 >> src/main.cbl" >> Makefile &&
echo "t:\xa\x09\x09java -jar ./junit-platform-console-standalone-1.9.3.jar --class-path dist --scan-class-path" >> Makefile &&
echo "\x09\x09echo \x22\x09\x22\x22\x22 >> src/main.cbl" >> Makefile &&
echo "clean:" >> Makefile &&
